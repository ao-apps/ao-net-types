...
[![Build](https://github.com/ao-apps/ao-net-types/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/ao-apps/ao-net-types/actions?query=workflow%3ABuild)
