 ...
 */
// Matches src/main/sql/com/aoindustries/net/Protocol-type.sql
public enum Protocol {
	...
	static {
		...
		for(int i = 0; i <= 255; i++) {
			if(protocolsByDecimal[i] == null) protocolsByDecimal[i] = UNASSIGNED;
		}
	}
	...
	public static Protocol valueOf(short decimal) throws IllegalArgumentException {
		if(decimal < 0) throw new IllegalArgumentException("decimal < 0: " + decimal);
		if(decimal > 255) throw new IllegalArgumentException("decimal > 255: " + decimal);
