...
public class UnmodifiableURIParameters implements URIParameters {
	...
	public static URIParameters wrap(URIParameters wrapped) {
		...
		if(wrapped == EmptyURIParameters.getInstance()) return wrapped;
		...
		// TODO: if(wrapped instanceof ServletRequestParameters) return wrapped;
		// Already wrapped
		if(wrapped instanceof UnmodifiableURIParameters) return wrapped;
		// Wrapping necessary
