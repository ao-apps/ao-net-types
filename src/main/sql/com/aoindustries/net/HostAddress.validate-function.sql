...
CREATE OR REPLACE FUNCTION "com.aoindustries.net"."HostAddress.validate" (address citext)
RETURNS text AS $$
DECLARE
  "parsed_inetAddress" "com.aoindustries.net"."InetAddress";
BEGIN
  IF "com.aoindustries.net"."DomainName.validate"(address) IS NULL
  THEN
  ...
  ELSE
    ...
    BEGIN
      "parsed_inetAddress" = address :: "com.aoindustries.net"."InetAddress";
...
COMMENT ON FUNCTION "com.aoindustries.net"."HostAddress.validate" (citext) IS
'Matches method com.aoindustries.net.HostAddress.valueOf, but with less verbose
