 ...
 */
CREATE OR REPLACE FUNCTION "com.aoindustries.net"."Path.validate" ("path" text)
RETURNS text AS $$
BEGIN
  -- Be non-null
...
COMMENT ON FUNCTION "com.aoindustries.net"."Path.validate" (text) IS
'Matches method com.aoindustries.net.Path.validate, but with less verbose
