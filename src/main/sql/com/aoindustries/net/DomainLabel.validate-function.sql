...
CREATE OR REPLACE FUNCTION "com.aoindustries.net"."DomainLabel.validate" (label citext)
RETURNS text AS $$
BEGIN
...
COMMENT ON FUNCTION "com.aoindustries.net"."DomainLabel.validate" (citext) IS
'Matches method com.aoindustries.net.DomainLabel.validate, but with less verbose
