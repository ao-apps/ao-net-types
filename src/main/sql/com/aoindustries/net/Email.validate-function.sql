...
CREATE OR REPLACE FUNCTION "com.aoindustries.net"."Email.validate" (
  "localPart" text,
...
COMMENT ON FUNCTION "com.aoindustries.net"."Email.validate" (text, "com.aoindustries.net"."DomainName") IS
'Matches method com.aoindustries.net.Email.validate, but with less verbose
...
BEGIN
  IF "domain" IS NOT NULL THEN
    "result" := "com.aoindustries.net"."DomainName.validate"("domain");
    IF "result" IS NOT NULL THEN
      RETURN "result";
    END IF;
  END IF;
  RETURN "com.aoindustries.net"."Email.validate"(
    "localPart",
    "domain" :: "com.aoindustries.net"."DomainName"
  );
END;
...
COMMENT ON FUNCTION "com.aoindustries.net"."Email.validate" (text, citext) IS
'Matches method com.aoindustries.net.Email.validate, but with less verbose
messages and without translations.  The database type is for final enforcement,
whereas higher level code should have already validated and provided more
detailed messages.';

CREATE OR REPLACE FUNCTION "com.aoindustries.net"."Email.validate" (address text)
RETURNS text AS $$
DECLARE
  "atPos" integer;
BEGIN
...
COMMENT ON FUNCTION "com.aoindustries.net"."Email.validate" (text) IS
'Matches method com.aoindustries.net.Email.validate, but with less verbose
messages and without translations.  The database type is for final enforcement,
whereas higher level code should have already validated and provided more
detailed messages.';
