...
CREATE DOMAIN "com.aoapps.net"."HostAddress" AS citext
  CHECK (value IS NULL OR "com.aoapps.net"."HostAddress.validate"(value) IS NULL);

COMMENT ON DOMAIN "com.aoapps.net"."HostAddress" IS
'Matches class com.aoapps.net.HostAddress';
